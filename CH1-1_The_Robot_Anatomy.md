...
| | 3D 光達 (LiDAR) | 多線雷射雷達，提供三維環境點雲資訊，可精準感知物體形狀、距離與高度。 | ◉<br>(立體輔助眼) | ◉ | ●<br>(室外) |
...
| | 一維力感測器 | 量測單一軸向的受力，主要用於線性關節，亦可整合進靈巧手的指尖用於單點偵測。 | ◉<br>(肌腱) | ◉ | ◉ |
| | 三維力感測器 | 量測三個方向（X、Y、Z）的受力，用於受力判斷及抓握控制。 | ◉<br>(本體感覺) | ● | ○ |
| | 六維力感測器 | 同時量測三軸受力（Fx、Fy、Fz）與三軸扭矩（Mx、My、Mz），用於精準力控與步態平衡。 | ●<br>(本體感覺) | ○ | ○ |
