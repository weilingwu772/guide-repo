...
| **感知**<br>*(外部感測)* | RGB 相機 | 由感光元件與鏡頭所組成，接收環境可見光並提供 2D 彩色影像輸出，主要用於物體識別與語意理解。 | ●<br>(眼睛) | ● | ● |
...
| | 2D 光達 (LiDAR) | 單線雷射雷達，用於室內平面建圖與二維導航。 | ○<br>(平面輔助眼) | ○ | ● |
| | 3D 光達 (LiDAR) | 多線雷射雷達，提供高精度三維環境點雲。 | ◉<br>(立體輔助眼) | ◉ | ●<br>(室外) |
| | 超音波 / 紅外線 | 用於近距離防撞與邊緣防跌落（防墜落）。 | ◉<br>(防撞輔助眼) | ◉ | ● |
| | 雷達 (RADAR) / 毫米波 | 戶外長距離或惡劣氣候下的環境偵測。 | ◉<br>(全天候輔助眼) | ◉ | ◉ |
