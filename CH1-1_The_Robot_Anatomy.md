...
這三種機器人皆是由上千或上萬個零組件所組成，結構相當複雜，但我們可從系統工程的角度，將所有零組件初步歸納成三大項目「感知（Perception）、運算（Cognition）與執行（Execution）」，相關界定內容與性能指標請參閱《Bot & Build：人機協作到共生的實踐指南》，而本文則依此為基礎走進開發世界。
